            ...
            <div class="row row-cols-1 row-cols-md-2 g-4" data-aos="fade-up" data-aos-duration="900">
                <div class="col">
                    <div class="card h-100 border-0 shadow-sm feature-card">
                        <img loading="lazy" decoding="async" src="assets/imgs/inner/features/machine_kiosk_1783400298207.png" class="card-img-top" alt="Digital Collection" style="height: 180px; object-fit: cover;">
                ...
                <div class="col">
                    <div class="card h-100 border-0 shadow-sm feature-card">
                        <img loading="lazy" decoding="async" src="assets/imgs/inner/features/security_lock_1783400190184.png" class="card-img-top" alt="Real-Time Analytics" style="height: 180px; object-fit: cover;">
                        <div class="card-body bg-light rounded-bottom">
