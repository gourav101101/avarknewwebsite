...
@section('page_title', 'Edit Blog: ' . $blog->title)

@section('content')

<div class="admin-card">
    <div class="card-header-admin">
        <h5><i class="fa-regular fa-pen" style="color: var(--admin-info); margin-right: 8px;"></i>Edit Blog</h5>
        <div class="action-buttons">
            <a href="{{ route('admin.blogs.index') }}" class="btn-admin btn-outline-admin btn-sm-admin">
                <i class="fa-regular fa-arrow-left"></i> Back
            </a>
            <a href="{{ route('blog-details', $blog->slug) }}" target="_blank" class="btn-admin btn-outline-admin btn-sm-admin">
                <i class="fa-regular fa-eye"></i> View Live
            </a>
        </div>
    </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-group-admin">
                        ...
                        <input type="text" name="slug" id="slug" class="form-input"
                               placeholder="auto-generated-from-title" value="{{ old('slug', $blog->slug) }}">
                    ...
                    <div class="form-group-admin">
                        ...
                        <textarea name="content" id="content" class="form-input content-editor"
                                  placeholder="Write your blog content here... (HTML supported)" required>{{ old('content', $blog->content) }}</textarea>
                ...
                <div class="col-lg-4">
                    <div class="form-group-admin">
                        ...
                        <input type="text" name="author" id="author" class="form-input"
                               placeholder="Author name" value="{{ old('author', $blog->author) }}" required>
                    </div>

                    <div class="form-group-admin">
                        <label for="tag">Tag / Category</label>
                        <input type="text" name="tag" id="tag" class="form-input"
                               placeholder="e.g. Agency, Avark" value="{{ old('tag', $blog->tag) }}">
                    </div>
                    ...
                    <div class="form-group-admin">
                        ...
                        <div class="file-upload-area" id="imageUploadArea">
                            ...
                            <p>Click or drag to update image</p>
