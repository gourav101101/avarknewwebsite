...
@section('content')
<style>
    .cancellation-policy { padding: 100px 0 110px; background: var(--site-bg-subtle, #F8FAFF); }
    .cancellation-policy__content { max-width: 960px; margin: 0 auto; color: #555; font-size: 16px; line-height: 1.8; }
    .cancellation-policy__intro { padding: 32px; margin-bottom: 34px; border-left: 4px solid #7444FD; border-radius: 0 14px 14px 0; background: var(--site-bg-soft, #F0F4FF); }
    ...
    .cancellation-policy a { color: #7444FD; text-decoration: underline; }
    .cancellation-policy__contact { padding: 24px 28px; border-radius: 14px; background: var(--site-bg-soft, #F0F4FF); }
